...
from fastapi_api_key import Argon2ApiKeyHasher
...
async def read_protected_data(api_key: str = Depends(security)):
    return {"message": "This is protected data", "api_key": api_key}


router_api_keys = create_api_keys_router(
    async_session_maker, hasher=hasher, router=router
)
